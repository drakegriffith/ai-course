...
COURSE-0-DECK.md is the slide source; `pandoc COURSE-0-DECK.md -o
COURSE-0-DECK.pptx --slide-level=2` builds the deck. Slides stay sparse and
everything you say lives in the speaker notes. Diagrams are generated by
`make_diagrams.py`; photos are openly licensed and credited on the last slide.
